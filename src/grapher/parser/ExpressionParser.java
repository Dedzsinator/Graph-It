...
import grapher.expression.AbsoluteValue;
import grapher.expression.Ceiling;
import grapher.expression.Cosecant;
import grapher.expression.Cosine;
import grapher.expression.Cotangent;
import grapher.expression.Difference;
import grapher.expression.Floor;
import grapher.expression.Function;
import grapher.expression.Log;
import grapher.expression.Modulo;
import grapher.expression.NthRoot;
import grapher.expression.Number;
import grapher.expression.Power;
import grapher.expression.Product;
import grapher.expression.Quantity;
import grapher.expression.Quotient;
import grapher.expression.Secant;
import grapher.expression.Sine;
import grapher.expression.SquareRoot;
import grapher.expression.Sum;
import grapher.expression.Tangent;
import grapher.expression.Variable;
